/* CAM 15 Nov 2008 - Increased measured width of text by 1, because under-measurement
 *   was causing word wrap in some instances.  Change was made to this line:
 *   
 *	  w = tt_GetDivW(tt_aElt[6]) + 1;  // Add extra width because of auto under-measurement
 *
 */
 
function bpgToolTip(aStr) {
	if (aStr && aStr != "") {
