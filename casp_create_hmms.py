...
# output: <shmm_root>/unique90_cropped_gathered_homologs/<seed>/<seed>_cropped_unique90.a2m
outdir = os.path.join(shmm_root_dir(), "unique90_cropped_gathered_homologs", seed)
outfile = os.path.join(outdir, "%s_cropped_unique90.a2m" % (seed))
if not os.path.exists(outfile):
  cmd = "uniqueseq_90.py %s" % seed
  do_step(cmd)
...
outdir = os.path.join(shmm_root_dir(),
    "top6000_unique90_cropped_gathered_homologs")
