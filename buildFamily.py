...
def inferPDB(basename):
    ...
    """Infers homologous PDB structures fromt he consensus sequence.

    First step is to blast the consensus sequence against PDB with e-value
cutoff of 100 to get potential candidates. All candidates are then scored
against the family HMM.
